...
class GUI_15001 extends GUI_BASE {
   avatar:UIStandAvatar;
   emojiImage:UIBitmap;
   emojiAnimation:UIAnimation;
   constructor(){
      super(15001);
   }
}
...
class GUI_15002 extends GUI_BASE {
   一张立绘情况:UIRoot;
   avatar_1_1:UIStandAvatar;
   两张立绘情况:UIRoot;
   avatar_2_1:UIStandAvatar;
   avatar_2_2:UIStandAvatar;
   三张立绘情况:UIRoot;
   avatar_3_1:UIStandAvatar;
   avatar_3_2:UIStandAvatar;
   avatar_3_3:UIStandAvatar;
   中间放大情况:UIRoot;
   avatar_4_1:UIStandAvatar;
   avatar_4_2:UIStandAvatar;
   avatar_4_3:UIStandAvatar;
   更多立绘情况请根据规范创建:UIRoot;
   constructor(){
      super(15002);
   }
}
...
class GUI_15003 extends GUI_BASE {
   背景:UIBitmap;
   list:UIList; // Item=15005
   标题:UIString;
   tipBox:UIRoot;
   文本:UIString;
   closeTipBox:UIButton;
   close:UIButton;
   category:UITabBox;
   constructor(){
      super(15003);
